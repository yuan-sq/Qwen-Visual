...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind-V Pretrain (Qwen2.5-0.5B + SigLIP2)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_i2t.parquet", help="Training data path")
    parser.add_argument('--from_weight', default='none', type=str, help="Weight to start from (none = from Qwen pretrained)")
    ...
    parser.add_argument('--freeze_llm', default=2, type=int, choices=[0, 1, 2],
                        help="Freeze strategy (0=all trainable, 1=LoRA, 2=only projector)")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-V-Pretrain-Qwen", help="Wandb project name")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MiniMind-V-Pretrain-Qwen-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
